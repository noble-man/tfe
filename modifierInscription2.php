		...
		<!--<table cellpadding="0" cellspacing="0">
			...
			<?php
				...
				try{
					...
					$inscr = new Inscription(array('fkStudent' => $_POST['id'], 'decision' => $_POST['decision'], 'remarque' => $_POST['remarque'], 'date' => $_POST['date'], 'montantVerse' => $_POST['montantVerse']));
					...
					if(!empty($_POST['id']))
						{
							...
							$etudiants= $inscr_mgt->update($inscr);
