						...
						for($cpt=0;$cpt<sizeof($etudiants);$cpt++)
						{
						   ...
						   // $etuds[$cpt]=new etudiant($donnees);
							...
							echo"		<td class='action'>
										...
										<a href='index.php?page=modifier inscription&id=$id&nomrech=$nomrech&prenomrech=$prenomrech&adresse=$adresse&code=$code&ville=$ville&tel=$tel&email=$email&statut=$statut' class='edit'>Edit</a>
