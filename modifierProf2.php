		...
		<!--<table cellpadding="0" cellspacing="0">
			...
			<?php
				...
				try{
					...
					$prof = new professeur(array('idProf'=>$_POST['id'],'nom' => $_POST['nomrech'], 'prenom' => $_POST['prenomrech'], 'email' => $_POST['email'] ));
					//f$etud=;
					...
					if(!empty($_POST['id']))
						{
							...
							$professeurs= $prof_mgt->update($prof);
							
							echo "<fieldset>";
								echo "<p>Les donn&eacute;es du professeur ont &eacute;t&eacute; modifi&eacute;es!</p>";
							echo "</fieldset>";
						}
